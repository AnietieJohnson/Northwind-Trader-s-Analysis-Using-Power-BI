...
2. Loaded the files into PowerQuery Editor for cleaning using 
...
- **Customer Preference for Shipping:** According to the pie chart, 40% of all customers chose United Package as their preferred shipping provider. whereas 30% is shared by Federal Shipping and Speedy Express.
